...
/**
 * The Search agent is the "base case" for comparison with all other agents. It
 * simply searches the entire grid in a sweeping fashion. Assuming there are
 * enough agents to overcome the random task-execution factor, the Search agent
 * should complete all tasks in gridsize^2/2 cycles. The number of Search agents
 * used is irrelevant - 1000 agents will take exactly the same amount of time as
 * 100.
 * 
