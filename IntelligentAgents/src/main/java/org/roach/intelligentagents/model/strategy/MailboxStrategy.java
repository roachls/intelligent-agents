...
public class MailboxStrategy extends CommunicatingAgentStrategy {
    ...
    /**
     * @param agent   the agent with this stratety
     * @param simGrid the grid
     * 
     */
    ...
    @Override
    public Optional<TaskToDo> getTaskToDo() { return taskToDo != null ? Optional.of(taskToDo) : Optional.empty(); }
    ...
    static class Mailbox {
        ...
        class MailMessage {
            ...
            public boolean equals(Object o) {
                if (o instanceof MailMessage mm) {
                    return (loc == mm.loc);
                }
    ...
    @Override
    public @NonNull String getDescription() { return "Mailbox strategy"; }
}