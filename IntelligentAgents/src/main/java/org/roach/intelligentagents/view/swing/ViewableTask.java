...
public class ViewableTask extends JComponent implements PropertyChangeListener {
     ...
     */
    public static void setSquareSize(final int aSquareSize) { squareSize = aSquareSize; }
    ...
    public void draw(final Graphics g) {
        ...
        g.setColor(color);
        // Draw the square
        g.fillRect(task.getLocation().x() * squareSize + 1, task.getLocation().y() * squareSize + 1, squareSize - 1,
                squareSize - 1);
    }
